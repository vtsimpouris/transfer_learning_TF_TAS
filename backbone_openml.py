...
def main(args):
    ...
    #	44241 , 44320
    dataset_id = 44241  # Replace with the actual ID of the OpenML dataset
    ...
    # Specify the base path where the images are stored
    base_path = r'C:\Users\vtsim\.openml\org\openml\www\datasets\44241\BRD_Micro\images'
    ...
    for epoch in range(args.start_epoch, epochs):
        ...
        if (test_stats["acc1"] > max_accuracy):
            ...
            weights_path = os.path.join(args.archs_dir + "/" + args.data_set,
                                        'best_model_{}_weights_TL.pth'.format(best_model_id))
